...
<body>
    ...
    <div id="all">
        ...
        <div id="center">
            ...
            售&nbsp;&nbsp;&nbsp;&nbsp;价：<%--售价--%>
            <asp:TextBox ID="gMoney" runat="server" Height="30px" Width="290px"></asp:TextBox> 
            <asp:RegularExpressionValidator id="RegularExpressionValidator4" runat="server" ErrorMessage="输入正确的价格" ControlToValidate="gMoney" ValidationExpression="^[0-9]{1,16}$"></asp:RegularExpressionValidator><br /><br />
            商品分类：<%--分类--%>
