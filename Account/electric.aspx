<%@ Page Language="C#" AutoEventWireup="true" CodeFile="electric.aspx.cs" Inherits="Account_electric" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>电子产品</title>
    <link rel="stylesheet" href="../Content/electric.css" type="text/css" media="all"/>
        ...
        <div id ="center">
            <div id ="show">
                ...
                <ItemTemplate>
                    ...
                    <div class="picture">
                        <a href="goods.aspx?id=<%# DataBinder.Eval(Container.DataItem,"images").ToString () %>"><asp:Image ID="Image1" runat="server" ImageAlign="Top" width="274px" height="207px" ImageUrl='<%# DataBinder.Eval(Container.DataItem,"images").ToString () %>' /></a>
                    </div><%--图片--%>
                    <div class="mess" style="font-family:微软雅黑">
                        <br />&nbsp;商品名称:<%# DataBinder .Eval (Container.DataItem ,"goodsname") %>
                        <br />&nbsp;价格(元):<%# DataBinder .Eval (Container.DataItem ,"goodsprice") %>
                    </div><%--信息--%>
                </div><%--商品框--%>
                </ItemTemplate>
                </asp:DataList>
