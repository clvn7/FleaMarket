<%@ Page Language="C#" AutoEventWireup="true" CodeFile="other.aspx.cs" Inherits="Account_other" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>其他</title>
    <link rel="stylesheet" href="../Content/other.css" type="text/css" media="all"/>
    ...
    <div id="all">
        ...
        <div id ="center"><%--中心--%>
            <div id ="show">
                ...
                <div id="foot" style="text-align:center;"><%--脚部--%>
                    <br /><br />
